(custom-set-variables
 ...
 '(package-selected-packages
   '(org-appear forge all-the-icons flycheck rust-mode lsp-mode ob-rust which-key doom-modeline pdf-tools company-box consult orderless vertico marginalia company treemacs winum evil-nerd-commenter evil-surround evil-collection rainbow-delimiters doom-themes use-package evil magit))
