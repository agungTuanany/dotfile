;;;; tuanany-tools-grep.el --- grep -*- lexical-binding: t -*-
...
(use-package grep
  :ensure nil   ; grep is built-in, so no need to run before loaded.
  :config
  (setq grep-find-ignored-directories '("tmp" "elpa" ".git" "build" "dist" "transient"))
  (setq-default grep-highlight-matches t
                grep-scroll-output t)
  )

;;; tuanany-tools-grep.el ends here
